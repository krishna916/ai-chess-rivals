  ...
  return (
    <div className="bg-card shadow rounded-xl border flex flex-col h-full min-h-[400px] max-h-[600px] lg:max-h-[calc(100vh-200px)]">
      <div className="p-4 border-b border-border flex items-center justify-between">
        <h2 className="text-lg font-semibold tracking-tight text-foreground">Match Activity</h2>
      ...
      >
        {activities.length === 0 ? (
          <div className="h-full flex flex-col items-center justify-center text-center p-4">
            ...
            <p className="text-xs text-muted-foreground/60 mt-1">Waiting for the match to start...</p>
          </div>
        ) : (
          <>
