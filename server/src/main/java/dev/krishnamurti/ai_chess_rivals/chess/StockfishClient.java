 ...
 *
 * <p>Implementations launch and manage the engine process, perform the UCI
 * handshake, and expose a small, stable API to the rest of the application.
 * Raw UCI commands and protocol details must not be exposed beyond this interface.
 */
public interface StockfishClient {

    /**
     * Resets the engine to a clean state for a new game.
     * Sends {@code ucinewgame} followed by an {@code isready} sync.
     *
