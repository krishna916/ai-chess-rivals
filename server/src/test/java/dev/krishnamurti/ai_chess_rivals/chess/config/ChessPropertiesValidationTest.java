...
class ChessPropertiesValidationTest {
  ...
  void whenPropertiesAreValid_thenNoViolations() {
    ChessProperties.Stockfish stockfish =
        new ChessProperties.Stockfish("stockfish/stockfish.exe", 1, 16, 10, 30);
  ...
  void whenThreadsIsTooLow_thenViolation() {
    ChessProperties.Stockfish stockfish =
        new ChessProperties.Stockfish("stockfish/stockfish.exe", 0, 16, 10, 30);
    ChessProperties properties = new ChessProperties(stockfish);
  ...
  void whenThreadsIsTooHigh_thenViolation() {
    ChessProperties.Stockfish stockfish =
        new ChessProperties.Stockfish("stockfish/stockfish.exe", 1025, 16, 10, 30);
    ChessProperties properties = new ChessProperties(stockfish);
  ...
  void whenHashMbIsTooLow_thenViolation() {
    ChessProperties.Stockfish stockfish =
        new ChessProperties.Stockfish("stockfish/stockfish.exe", 1, 0, 10, 30);
    ChessProperties properties = new ChessProperties(stockfish);
  ...
  void whenStartupTimeoutIsTooLow_thenViolation() {
    ChessProperties.Stockfish stockfish =
        new ChessProperties.Stockfish("stockfish/stockfish.exe", 1, 16, 0, 30);
    ChessProperties properties = new ChessProperties(stockfish);
  ...
  void whenMoveTimeoutIsTooLow_thenViolation() {
    ChessProperties.Stockfish stockfish =
        new ChessProperties.Stockfish("stockfish/stockfish.exe", 1, 16, 10, 0);
    ChessProperties properties = new ChessProperties(stockfish);
