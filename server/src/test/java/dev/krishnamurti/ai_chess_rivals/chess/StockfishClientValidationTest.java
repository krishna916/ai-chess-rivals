...
/**
 * Proves that Stockfish starts, identifies itself correctly, and responds to the UCI readiness
 * check. Standalone — no Spring context, no database.
 *
 * <p>Run with: mvn test -Dtest=StockfishClientValidationTest
