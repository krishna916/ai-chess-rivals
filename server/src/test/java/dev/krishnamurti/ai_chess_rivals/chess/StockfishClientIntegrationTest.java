 ...
 * Requires a real Stockfish binary — set STOCKFISH_PATH env var or use the default.
 *
 * Run with: mvn test -Dtest=StockfishClientIntegrationTest -DSTOCKFISH_PATH=stockfish/stockfish.exe
 */
class StockfishClientIntegrationTest {
    ...
    /**
     * AC1 + AC2: Engine starts and UCI handshake completes.
     * Verified implicitly by @BeforeEach reaching this point without exception.
     */
    @Test
